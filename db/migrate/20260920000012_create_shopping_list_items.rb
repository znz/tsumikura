class CreateShoppingListItems < ActiveRecord::Migration[8.1]
  def change
    create_table :shopping_list_items, id: :uuid, default: -> { "uuidv7()" } do |t|
      ...
      t.references :item, type: :uuid, foreign_key: { on_delete: :restrict }, index: false
      ...
      t.references :added_by, type: :uuid, null: false, foreign_key: { to_table: :users, on_delete: :restrict }
